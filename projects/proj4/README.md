...
# 交互样例
下面是一组我们实现的截屏，你实现的界面可能有所不同，但是功能必须是一直的，如下节所述。
...
# GUI布局
下面是我们的GUI布局的草图，我们描述了关键GUI组件和它们的近似布局。我们也描述了组件之间的容器包含关系，一些相关的实例变量和标示出来了。
...
下面是GUI的实现注意点：
- 在本项目中，我们将使用**GridBagLayut**作为frames和panels的布局管理器。
